...
const Profile = () => {
          ...
          <section>
            <div className='flex flex-col gap-5'>
              ...
              <div className='flex flex-col gap-1'>
                ...
                <span>JSSATEN 26</span>
                <span>Selenophile</span>
                <span>Noida</span>
              </div>
            </div>
          </section>
  ...
  return (
    <div key={post?._id} className="relative group cursor-pointer">
      <img src={post?.image || "/default-image.png"} alt="postimage" className="rounded-sm my-2 w-full aspect-square object-cover" />
